...
int main(void)
{
	...
	int *original_array1_element1 = darr_address(&array1, 0);
	*original_array1_element1 = original_array1_element1_value;
	...
	int *original_array2_element1 = darr_address(&array2, 0);
	*original_array2_element1 = original_array2_element1_value;
	int *original_array2_element2 = darr_address(&array2, 1);
	*original_array2_element2 = original_array2_element2_value;
	...
	int *array1_element1 = darr_address(&array1, 0);
	...
	int *array1_element2 = darr_address(&array1, 1);
	...
	int *array2_element1 = darr_address(&array2, 0);
